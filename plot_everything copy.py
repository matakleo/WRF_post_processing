...
for PBL in PBLS:
	...
	for CL in CLS:
		...
		lvl_heights=[]
		lvl_heights = Extract_the_shit(csv_file, lvl_heights, 'lvl_heights')
		...
		PBLHS = []
		PBLHS = Extract_the_shit (csv_file, PBLHS, 'PBLH')
		...
		exch_list=[]
		exch=Extract_the_shit(csv_file,exch_list,'avg_vert_exch')
		...
		exch_list=[]
		exch=Extract_the_shit(csv_file,exch_list,'avg_vert_exch_akmkl')
		...
		Wind_Speed = []
		# Wind_Speed_simulation = flatten_the_curve(Extract_the_shit (csv_file, Wind_Speed, 'All_Max_WND_SPD_10'))
