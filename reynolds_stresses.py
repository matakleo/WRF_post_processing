...
gs = gridspec.GridSpec(1,7,figure=fig,wspace=0)
...
# 	# 					# Plot Reynolds stresses.
						print('l=',l)
						print('l+3 =',l+3)
						axess[l].plot(Rey_uruth, z_5000, color=colors[c], linewidth=2, label = 'hpbl - '+CL)
						axess[l+1].plot(Rey_uruz, z_5000, color=colors[c], linewidth=2, label = 'hpbl - '+CL)
						axess[l+2].plot(Rey_uthuz, z_5000, color=colors[c], linewidth=2, label = 'hpbl - '+CL)
